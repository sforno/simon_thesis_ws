...
This case presents a deviation (a translation) due to angular drift; therefore the first parameter that should be tuned is \textbf{alfa4}. The strategy is here to leave the alfa1,2,3 as default to \textbf{2} by only changing the alfa4. \\
