...
if(NOT "/home/simoneforno/simon_ws/src/navigation/clear_costmap_recovery/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/navigation/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
