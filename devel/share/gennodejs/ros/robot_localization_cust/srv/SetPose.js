...
// (in-package robot_localization_cust.srv)
...
class SetPoseRequest {
  ...
  static datatype() {
    ...
    return 'robot_localization_cust/SetPoseRequest';
  }
...
class SetPoseResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_localization_cust/SetPoseResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '4f3e0bbe7a24e1f929488cd1970222d3'; },
  datatype() { return 'robot_localization_cust/SetPose'; }
};
