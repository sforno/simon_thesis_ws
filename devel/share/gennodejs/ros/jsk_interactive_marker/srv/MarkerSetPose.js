...
class MarkerSetPoseRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MarkerSetPoseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MarkerSetPoseRequest
    let len;
    let data = new MarkerSetPoseRequest(null);
  ...
  static datatype() {
    ...
    return 'jsk_interactive_marker/MarkerSetPoseRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ad9cd9afd2203415fba0c5648ca2decb';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MarkerSetPoseRequest(null);
...
class MarkerSetPoseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MarkerSetPoseResponse
    // Serialize message field [pose]
    bufferOffset = geometry_msgs.msg.PoseStamped.serialize(obj.pose, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MarkerSetPoseResponse
    let len;
    let data = new MarkerSetPoseResponse(null);
    // Deserialize message field [pose]
    data.pose = geometry_msgs.msg.PoseStamped.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'jsk_interactive_marker/MarkerSetPoseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MarkerSetPoseResponse(null);
    if (msg.pose !== undefined) {
      resolved.pose = geometry_msgs.msg.PoseStamped.Resolve(msg.pose)
    }
    else {
...
module.exports = {
  Request: MarkerSetPoseRequest,
  Response: MarkerSetPoseResponse,
  md5sum() { return 'f931e0f5104a6b8bb870d68dbdfaccd9'; },
  datatype() { return 'jsk_interactive_marker/MarkerSetPose'; }
};
