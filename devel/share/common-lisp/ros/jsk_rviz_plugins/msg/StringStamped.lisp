...
(cl:defmethod cl:initialize-instance :after ((m <StringStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jsk_rviz_plugins-msg:<StringStamped> is deprecated: use jsk_rviz_plugins-msg:StringStamped instead.")))
...
(cl:defmethod data-val ((m <StringStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_rviz_plugins-msg:data-val is deprecated.  Use jsk_rviz_plugins-msg:data instead.")
  (data m))
