...
if(NOT "/home/simoneforno/simon_ws/src/data_converter/include " STREQUAL " ")
  set(data_converter_INCLUDE_DIRS "")
  set(_include_dirs "/home/simoneforno/simon_ws/src/data_converter/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'data_converter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'data_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/data_converter/${idir}'.  ${_report}")
    endif()
