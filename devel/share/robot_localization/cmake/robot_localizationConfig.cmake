...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/simoneforno/simon_ws/src/robot_localization_cust)
  set(robot_localization_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tom Moore <ayrton04@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/robot_localization_cust/${idir}'.  Ask the maintainer 'Tom Moore <ayrton04@gmail.com>' to fix it.")
    endif()
