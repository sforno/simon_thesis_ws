...
if("TRUE" STREQUAL "TRUE")
  set(husky_bringup_SOURCE_PREFIX /home/simoneforno/simon_ws/src/husky-kinetic-devel/husky_bringup)
  set(husky_bringup_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  ...
  set(husky_bringup_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'husky_bringup' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Tony Baltovski <tbaltovski@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'husky_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/husky-kinetic-devel/husky_bringup/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Tony Baltovski <tbaltovski@clearpathrobotics.com>' to fix it.")
    endif()
