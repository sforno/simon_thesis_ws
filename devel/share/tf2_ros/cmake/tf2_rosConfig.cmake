...
if("TRUE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /home/simoneforno/simon_ws/src/geometry2/tf2_ros)
  set(tf2_ros_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
...
if(NOT "/home/simoneforno/simon_ws/src/geometry2/tf2_ros/include " STREQUAL " ")
  set(tf2_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/simoneforno/simon_ws/src/geometry2/tf2_ros/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/geometry2/tf2_ros/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
