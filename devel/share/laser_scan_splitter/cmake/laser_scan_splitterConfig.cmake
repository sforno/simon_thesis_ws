...
if("TRUE" STREQUAL "TRUE")
  set(laser_scan_splitter_SOURCE_PREFIX /home/simoneforno/simon_ws/src/scan_tools/laser_scan_splitter)
  set(laser_scan_splitter_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  ...
  set(laser_scan_splitter_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
...
if(NOT "/home/simoneforno/simon_ws/src/scan_tools/laser_scan_splitter/include " STREQUAL " ")
  set(laser_scan_splitter_INCLUDE_DIRS "")
  set(_include_dirs "/home/simoneforno/simon_ws/src/scan_tools/laser_scan_splitter/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_scan_splitter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ivan Dryanovski <ccnyroboticslab@gmail.com>, Carlos <cjaramillo@gc.cuny.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_scan_splitter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/scan_tools/laser_scan_splitter/${idir}'.  Ask the maintainer 'Ivan Dryanovski <ccnyroboticslab@gmail.com>, Carlos <cjaramillo@gc.cuny.edu>' to fix it.")
    endif()
