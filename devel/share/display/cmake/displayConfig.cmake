...
if("TRUE" STREQUAL "TRUE")
  set(display_SOURCE_PREFIX /home/simoneforno/simon_ws/src/display)
  set(display_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  set(display_INSTALL_PREFIX "")
  set(display_PREFIX ${display_DEVEL_PREFIX})
else()
  set(display_SOURCE_PREFIX "")
  set(display_DEVEL_PREFIX "")
  set(display_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'display' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'pem <pem@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'display' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/display/${idir}'.  Ask the maintainer 'pem <pem@todo.todo>' to fix it.")
    endif()
