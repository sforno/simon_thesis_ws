...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /home/simoneforno/simon_ws/src/gazebo_ros_pkgs/gazebo_dev)
  set(gazebo_dev_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  ...
  set(gazebo_dev_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/gazebo_ros_pkgs/gazebo_dev/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
...
set(pkg_cfg_extras "/home/simoneforno/simon_ws/src/gazebo_ros_pkgs/gazebo_dev/cmake/gazebo_dev-extras.cmake")
