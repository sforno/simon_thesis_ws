...
if("TRUE" STREQUAL "TRUE")
  set(teb_local_planner_SOURCE_PREFIX /home/simoneforno/simon_ws/src/teb_local_planner)
  set(teb_local_planner_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  ...
  set(teb_local_planner_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
...
if(NOT "/home/simoneforno/simon_ws/devel/include;/home/simoneforno/simon_ws/src/teb_local_planner/include;/usr/include/suitesparse;/opt/ros/kinetic/include/g2o " STREQUAL " ")
  set(teb_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/simoneforno/simon_ws/devel/include;/home/simoneforno/simon_ws/src/teb_local_planner/include;/usr/include/suitesparse;/opt/ros/kinetic/include/g2o")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'teb_local_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Christoph Rösmann <christoph.roesmann@tu-dortmund.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'teb_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/teb_local_planner/${idir}'.  Ask the maintainer 'Christoph Rösmann <christoph.roesmann@tu-dortmund.de>' to fix it.")
    endif()
