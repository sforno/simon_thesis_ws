...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/simoneforno/simon_ws/src/open_karto)
  set(open_karto_DEVEL_PREFIX /home/simoneforno/simon_ws/devel)
  ...
  set(open_karto_INSTALL_PREFIX /home/simoneforno/simon_ws/install)
...
if(NOT "/home/simoneforno/simon_ws/src/open_karto/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/simoneforno/simon_ws/src/open_karto/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simoneforno/simon_ws/src/open_karto/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
