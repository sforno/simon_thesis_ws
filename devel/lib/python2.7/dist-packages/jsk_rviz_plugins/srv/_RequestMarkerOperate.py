...
bool mesh_use_embedded_materials"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.operate.mesh_use_embedded_materials))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.operate.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.operate.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.operate.description = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.operate.mesh_resource = str[start:end].decode('utf-8')
      else:
