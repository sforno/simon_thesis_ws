...
"""autogenerated by genpy from jsk_interactive_marker/MarkerPose.msg. Do not edit."""
import sys
...
class MarkerPose(genpy.Message):
  _md5sum = "cbb82805055f8f87cec211c5459c476c"
  _type = "jsk_interactive_marker/MarkerPose"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint8 GENERAL=0
uint8 HEAD_MARKER=1
...
"""
  ...
  __slots__ = ['type','pose','marker_name']
  _slot_types = ['int8','geometry_msgs/PoseStamped','string']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_b3I().pack(_x.type, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.type, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
