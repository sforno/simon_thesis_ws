...
"""autogenerated by genpy from jsk_interactive_marker/JointTrajectoryWithType.msg. Do not edit."""
import sys
...
class JointTrajectoryWithType(genpy.Message):
  _md5sum = "60e366ad2005e5bee332903472737b12"
  _type = "jsk_interactive_marker/JointTrajectoryWithType"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string[]','jsk_interactive_marker/JointTrajectoryPointWithType[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointTrajectoryWithType, self).__init__(*args, **kwds)
    ...
    try:
      ...
      for val1 in self.points:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_B().pack(val1.wait))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.points = []
      for i in range(0, length):
        val1 = jsk_interactive_marker.msg.JointTrajectoryPointWithType()
        start = end
        end += 1
        ...
        (val1.wait,) = _get_struct_B().unpack(str[start:end])
        val1.wait = bool(val1.wait)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
