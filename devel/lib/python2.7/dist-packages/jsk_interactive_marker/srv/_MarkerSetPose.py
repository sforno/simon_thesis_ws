...
"""autogenerated by genpy from jsk_interactive_marker/MarkerSetPoseRequest.msg. Do not edit."""
import sys
...
class MarkerSetPoseRequest(genpy.Message):
  _md5sum = "ad9cd9afd2203415fba0c5648ca2decb"
  _type = "jsk_interactive_marker/MarkerSetPoseRequest"
...
float32 a
"""
  __slots__ = ['marker_name','pose','markers']
  _slot_types = ['string','geometry_msgs/PoseStamped','visualization_msgs/Marker[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MarkerSetPoseRequest, self).__init__(*args, **kwds)
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from jsk_interactive_marker/MarkerSetPoseResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class MarkerSetPoseResponse(genpy.Message):
  _md5sum = "3f8930d968a3e84d471dff917bb1cdae"
  _type = "jsk_interactive_marker/MarkerSetPoseResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MarkerSetPoseResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.pose is None:
        self.pose = geometry_msgs.msg.PoseStamped()
    else:
...
def _get_struct_7d():
    ...
    if _struct_7d is None:
        _struct_7d = struct.Struct("<7d")
    return _struct_7d
class MarkerSetPose(object):
  _type          = 'jsk_interactive_marker/MarkerSetPose'
  _md5sum = 'f931e0f5104a6b8bb870d68dbdfaccd9'
  _request_class  = MarkerSetPoseRequest
  _response_class = MarkerSetPoseResponse
