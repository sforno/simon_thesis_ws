...
"""autogenerated by genpy from robot_localization_cust/GetStateRequest.msg. Do not edit."""
import sys
...
class GetStateRequest(genpy.Message):
  ...
  _type = "robot_localization_cust/GetStateRequest"
...
def _get_struct_2I():
    ...
    return _struct_2I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot_localization_cust/GetStateResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetStateResponse(genpy.Message):
  ...
  _type = "robot_localization_cust/GetStateResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
float64[15] state
...
class GetState(object):
  _type          = 'robot_localization_cust/GetState'
