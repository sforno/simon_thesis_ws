...
class ObstacleMsg(genpy.Message):
  _md5sum = "50cb9b6378ab445243f75ee2b793a482"
...
float64 y
float64 z"""
  __slots__ = ['header','polygon','id','orientation','velocities']
  _slot_types = ['std_msgs/Header','geometry_msgs/Polygon','int64','geometry_msgs/Quaternion','geometry_msgs/TwistWithCovariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,polygon,id,orientation,velocities
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_q10d().pack(_x.id, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.velocities.twist.linear.x, _x.velocities.twist.linear.y, _x.velocities.twist.linear.z, _x.velocities.twist.angular.x, _x.velocities.twist.angular.y, _x.velocities.twist.angular.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.velocities.twist.linear.x, _x.velocities.twist.linear.y, _x.velocities.twist.linear.z, _x.velocities.twist.angular.x, _x.velocities.twist.angular.y, _x.velocities.twist.angular.z,) = _get_struct_q10d().unpack(str[start:end])
      start = end
      end += 288
