...
ground_pose = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\Ekf\rectangular_path\high_freq\odom+marker\f4\ground_truth_posit.csv';
ground_orient = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\Ekf\rectangular_path\high_freq\odom+marker\f4\ground_truth_orient.csv';
delimiter = ',';
startRow = 2;
...
ground_X = ground_X(44:end);
ground_Y = dataArray_groundpose{:, 3}-5.6;
ground_Y = ground_Y(44:end);
...
% euler_ref and actual should be adjusted, fix one value and then take away
% values from one point on, add zeros to make vectors the same lenght

euler_ref = euler_ref(740:end);
euler_ref(266:1441)= euler_ref(266:1441)+6.2831; %add 360 to take away the step
