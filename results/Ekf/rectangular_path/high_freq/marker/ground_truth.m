...
ground_pose = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\Ekf\rectangular_path\high_freq\marker\ground_truth_posit.csv';
ground_orient = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\Ekf\rectangular_path\high_freq\marker\ground_truth_orient.csv';
delimiter = ',';
startRow = 2;
...
ground_X = ground_X(45:end);
ground_Y = dataArray_groundpose{:, 3}-5.6;
ground_Y = ground_Y(45:end);
...
euler_ref(265:1928)= euler_ref(265:1928)+6.2831; %add 360 to take away the step
