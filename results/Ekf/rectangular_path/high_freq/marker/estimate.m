...
estimated_pose = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\Ekf\rectangular_path\high_freq\marker\pose_estimate_posit.csv';
estimated_orient = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\Ekf\rectangular_path\high_freq\marker\pose_estimate_orient.csv';
delimiter = ',';
startRow = 2;
...
estim_X = estim_X(33:end);
estim_X = estim_X(1:3252);
estim_Y = dataArray_estimpose{:, 3};
estim_Y = estim_Y(33:end);
estim_Y = estim_Y(1:3252);
...
euler_actual = euler_actual(740:end);
