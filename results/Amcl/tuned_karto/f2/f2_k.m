...
filename_pose = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\graph_localization\tuned_karto\f2\pose.csv';
filename_odom = 'C:\Users\Simone\Dropbox\Abschlussarbeit\PEM\4-Results\graph_localization\tuned_karto\f2\odom.csv';
delimiter = ';';
startRow = 2;
...
for index = 1:318 % fieldposeposepositionx_pose 150 = roughly 37
...
for index = 320:432 %look at fieldposeposepositiony_pose index 0:13 meters
    
if(fieldposeposepositiony_pose(index,1)>= By(1,j) - 0.11 && fieldposeposepositiony_pose(index,1)<= By(1,j) + 0.11)
